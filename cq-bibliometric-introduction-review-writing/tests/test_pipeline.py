...
from evidence import build_evidence, citation_minimum, citation_trigger_errors, claim_ids_in_text, punctuation_errors, sync_references, sync_review_references, topic_citation_quotas, validate, write_introduction
...
class WorkflowTests(unittest.TestCase):
    ...
    def test_manifest_schema_migrates_without_touching_corpus(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(manifest["skill_schema_version"], 5); self.assertEqual(before, corpus.read_bytes())
